      ...
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-12">
        <div className="flex-1 text-center lg:text-left">
          ...
          <h2 className="text-3xl lg:text-5xl font-extrabold mt-6 leading-tight text-gray-900">
            Supercharge Your <br /> <span className="bg-linear-to-r from-[#4F39F6] via-[#9514FA] to-[#4F39F6] bg-clip-text text-transparent animate-gradient-text shrink-0">Digital Workflow</span>
          </h2>
          ...
          <div className="mt-7 flex gap-4 justify-center lg:justify-start">
            <button className="bg-linear-to-r from-[#4F39F6] to-[#9514FA] text-white rounded-4xl hover:bg-[#6a20d6] hover:scale-105 border-none px-4 py-3 font-semibold active:scale-95 transition-all cursor-pointer">Explore Products</button>
